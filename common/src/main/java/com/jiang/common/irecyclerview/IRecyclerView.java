package com.jiang.common.irecyclerview;
...
public class IRecyclerView extends RecyclerView {
    ...
    public void setLoadMoreFooterView(@LayoutRes int loadMoreFooterLayoutRes) {
        ensureLoadMoreFooterContainer();
        final View loadMoreFooter = LayoutInflater.from(BaseApplication.getAppContext()).inflate(loadMoreFooterLayoutRes, mLoadMoreFooterContainer, false);
